...
<title>Mosquée <?=$country?> - Salle de Prière en <?=$country?></title>

<meta name="description" content="Mosquées en <?=$country?> - Consultez la liste des salles de prière et mosquées où prier en <?=$country?> avec l'adresse et le plan détaillée des lieux de culte."/>