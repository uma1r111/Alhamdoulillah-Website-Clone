...
for ($i=1; $i<2400; $i++)
{
	...
	${'url'.$i} = "../mosquee/${'continent'.$i}/${'country'.$i}/${'ville'.$i}.html";
 
	if (!file_exists("../mosquee/${'continent'.$i}")) mkdir("../mosquee/${'continent'.$i}/", 0700);
	if (!file_exists("../mosquee/${'continent'.$i}/${'country'.$i}")) mkdir("../mosquee/${'continent'.$i}/${'country'.$i}", 0700);
...
<?php include("../../../generate/city-salat.php");?>

</td>

<td id="colonnes"><?php include("../../../../inc/droite.php");?>
