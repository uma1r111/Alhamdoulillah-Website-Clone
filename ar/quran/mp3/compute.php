...
<h2>الاستماع إلى القرآن الكريم MP3</h2>
	
	<p>سوف تجد في هذه الصفحة 114 <a href=\"surahs.html\">MP3 السور من القرآن الكريم</a> من القراء الأكثر شهرة. انقر على اسم قاري أردت الاستماع عبر الإنترنت أو تحميل MP3 للوصول إلى قائمة السور المتاحة.</p>
...
<h3>تلاوات القرآن MP3</h3>

<ul>
<li><b>$mp3s</b> تلاوات من القرآن الكريم</li>
<li><b>$cp</b> قراء</li>
</ul>
...
";	
	...
	echo "
		...
		for ($f=1; $f<30; $f++)
		{
			...
			<li style=\"line-height:2em;\"><a href=\"${'qariURL'.$f}\"><b>${'qariNom'.$f}</b></a>, ${'y'.$f} سور</li>
