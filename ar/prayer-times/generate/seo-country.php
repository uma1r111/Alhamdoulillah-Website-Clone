...
<title>مواقيت الصلاة في <?=$country?> <?echo date(Y);?> - أوقات الصلاة <?=$country?></title>

<meta name="description" content="جميع أوقات الصلاة في قارة <?=$country?> - اضغط على هذا الرابط لعرض أوقات الصلاة في <?echo $country?>، تقويم صلاة والجدول الزمني للمدن في <?echo $country?>."/>
