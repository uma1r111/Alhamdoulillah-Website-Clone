...
<form method="post" name="method" id="method" action="<?php echo $_SERVER['PHP_SELF'];?>"><label for="calcul">طريقة الحساب :</label> 
...
<tr><td>
<form method="post" name="asr" id="asr" action="<?php echo $_SERVER['PHP_SELF'];?>"><label for="hanafi">وقت العصر :</label> 
...
<tr><td>
<form method="post" name="heure" id="heure" action="<?php echo $_SERVER['PHP_SELF'];?>"><label for="time">تنسيق الوقت :</label>  
...
<h3>عمليات البحث المتعلقة بأوقات الصلاة في <?echo $VilleNom?> :</h3>

<ul>
	<li>ما هي أوقات الصلاة في <?echo $VilleNom?> ?</li>
	<li>اوقات صلاة <?echo $VilleNom?></li>
	<li>وقت صلاة مسجد <?echo $VilleNom?></li>
	<li>وقت صلاة المسلمين في <?echo $VilleNom?></li>
	<li>صلاة التقويم في <?echo $VilleNom?></li>
</ul>
