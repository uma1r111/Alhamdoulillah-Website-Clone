<?
    ...
    function initsuraData()
    {
        ...
        $dataItems = Array("index", "continent", "country", "city", "lat", "long", "pop", "continentAR", "countryAR", "cityAR", "zone");
...
<title>جدول رمضان <?=$continent?> <?echo date(Y);?> - تقويم رمضان  في <?=$continent?></title>

<meta name="description" content="جداول رمضان للقارة <?=$continent?> - اطلع على تقويم شهر رمضان في <?echo $continent?> والجدول الزمني لإمساك والإفطار."/>
