...
<p>Voici le détail du calendrier musulman qui correspond au mois de <?php echo $textmonth." ".$year?>. Il contient en partie les mois de <?php echo $mois_hijri?>. Selon les pays, il peut y avoir un décalage d'un jour de plus ou de moins, selon les observations de la lune. N'oubliez pas qu'il est conseillé de jeûner les jours blancs. Ce sont les <span style="color:red;">13</span>, <span style="color:red;">14</span> et <span style="color:red;">15</span> de chaque mois. A voir aussi, <a href="/horaires-prieres/ramadan/">le calendrier du Ramadan</a>. En dehors des mois du Ramadan et de Dhoul Hidjah, le calendrier ci-dessous est basé sur la calcul astronomique à l'échelle de la Terre. La raison est que pour ces 2 mois particuliers, la majorité des autorités religieuses utilisent la vision oculaire qui nécessite un ajustement manuel du calendrier.</p>
...
{
$HMonths=$HMonths+1;
$HDays=round($HDays-29.531182);//ramadan adjust
}
...
<?  
		  ...
		  echo "
		  <p><b>Mouharram 1442 (mi-2020)</b></p>
		  ...
		  if ($date[month] == 11) $date[month] = "Novembre";
		  if ($date[month] == 12) $date[month] = "Décembre";
		  echo "<li>Jeûne de Achoura : $date[day] $date[month] $date[year]</li></ul>";
		  ...
		  if ($date[month] == 12) $date[month] = "Décembre";
		  echo "
		  <p><b>Début des mois sacrés</b></p>
		  <ul><li>Mouharram : $date[day] $date[month] $date[year]</li>";
		  ...
		  if ($date[month] == 11) $date[month] = "Novembre";
		  if ($date[month] == 12) $date[month] = "Décembre";
		  echo "<li>Radjab : $date[day] $date[month] $date[year]</li>";
		  
		  $date = $d->u2g(1,11,1442);
		  if ($date[month] == 1) $date[month] = "Janvier";
		  if ($date[month] == 2) $date[month] = "Février";
		  if ($date[month] == 3) $date[month] = "Mars";
		  if ($date[month] == 4) $date[month] = "Avril";
		  ...
		  if ($date[month] == 11) $date[month] = "Novembre";
		  if ($date[month] == 12) $date[month] = "Décembre";
		  echo "<li>Dhoul Qi'dah : $date[day] $date[month] $date[year]</li>";
		  ...
		  if ($date[month] == 11) $date[month] = "Novembre";
		  if ($date[month] == 12) $date[month] = "Décembre";
		  echo "<li>Dhoul Hidjah : $date[day] $date[month] $date[year]</li></ul>";
