...
})(window,document,'script','dataLayer','GTM-T6ZJ65DF');</script>
...
$temporaire = $_SERVER['SCRIPT_NAME'];

$canon = str_replace("index.html", "", $temporaire);

if (strpos($test,'blog') == false) echo '<link rel="canonical" href="'.$url="https://".$_SERVER['HTTP_HOST'].$canon.$url.'">';?>
