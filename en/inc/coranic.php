...
function versets($sourate, $start, $end){
 ...
 $lines = simplexml_load_file($_SERVER['DOCUMENT_ROOT'].'/auto/en/Chapter'.$surahforfile.'.xml');
...
if ($version == 0) echo ' <b>}</b> <span class="coran">[Surah '.$sourate.', '.$nom.' - Verses '.$debut.' à '.$fin.']</span></p>';
if ($version == 1) echo ' <b>}</b> <span class="coran">[Surah '.$sourate.', '.$nom.' - Verse '.$debut.']</span></p>';
