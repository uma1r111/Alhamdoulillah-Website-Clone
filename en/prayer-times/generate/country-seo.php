...
<title>Prayer Time <?=$country?> <?echo date(Y);?> - Salat Timetable <?=$country?></title>

<meta name="description" content="All the prayer times for <?echo $country?> (<?=$continent?>) - Click here to view the prayer times in <?echo $country?>, salat calendar and timetable for cities of <?echo $country?>."/>
