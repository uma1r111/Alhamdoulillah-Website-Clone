...
<h1>Prayer Time <?=$country?></h1>

<p style="padding-top:20px;"><a href="/en/prayer-times/world/">World</a> > <a href="/en/prayer-times/world/<?echo str_replace(" ", "-", strtolower($continent))?>/"><?echo $continent?></a> > <?echo $country?></strong></p>

<p width="100%">Here are the prayer times for <?echo number_format($count)?> cities of <?echo $country?>.</p>
...
if ($country == "Morocco") ${'timezone'.$i} = ${'timezone'.$i};
?>
<script>
var tz = '<?=${'zone'.$i}?>';
var date = new Date();
...
<h3>Prayer time for $country cities</h3>

<p>You can see prayer times for others cities in $country. By the way, we inform you about the number of people for each city on this country.</p> <table style=\"padding:0px; margin:0px;\"><tr><td style=\"padding:0px; margin:0px;\"><ul style=\"padding-top:0px; margin-top:0px;\">
