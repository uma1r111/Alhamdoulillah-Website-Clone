...
<form method="post" name="method" id="method" action="<?php echo $_SERVER['PHP_SELF'];?>">Calculation method: 
...
<tr><td>
<form method="post" name="asr" id="asr" action="<?php echo $_SERVER['PHP_SELF'];?>">Asr time : 
...
<tr><td>
<form method="post" name="heure" id="heure" action="<?php echo $_SERVER['PHP_SELF'];?>">Time format : 
