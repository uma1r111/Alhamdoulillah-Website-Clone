...
<title>Ramadan Timetable <?=$country?> <?echo date(Y);?> - Ramadan Calendar <?=$country?></title>

<meta name="description" content="Ramadan schedule for <?echo $country?> (<?=$continent?>) - Click here to access the Ramadan fasting calendar for the cities of <?echo $country?>."/>
