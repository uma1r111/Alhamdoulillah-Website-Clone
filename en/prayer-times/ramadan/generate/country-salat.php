...
<h1>Ramadan Timetable <?=$country?></h1>

<?php include("../../../../../inc/pub-content.php");?>

<p style="padding-top:20px;"><a href="/en/prayer-times/ramadan/">Ramadan Calendar</a> > <a href="/en/prayer-times/ramadan/<?echo str_replace(" ", "-", strtolower($continent))?>/"><?echo $continent?></a> > <?echo $country?></strong></p>



<? if ($count == "1") $correct = "city";?>
<? if ($count > "1") $correct = "cities";?>
<? if ($count == "0") $correct = "city";?>

<p>Here are the Ramadan timetables for <?echo "$count $correct"?> in <?echo $country?>.</p>

<center><div style="width:100%; display:block; height:5px; background-color:slategray; margin:0px;"></div></center>

<img style="float:right; margin-right:25px; margin-top:9px; height:33px; width:45px;" src="/en/prayer-times/flags/<?=str_replace(" ", "-", strtolower($country))?>.GIF">

<h2>Ramadan Calendar <?=$country?> (First day)</h2>

<table class="timetable" style="margin-right:auto; margin-left:auto;">
<tr style="font-weight:bold;"><td style="text-align:left;">City</td><td style="width:4.5em;">Fajr [Imsak]</td><td style="width:4.5em;">Dhuhr</td><td style="width:4.5em;">Asr</td><td style="width:4.5em;">Maghrib [Iftar]</td><td style="width:4.5em;">Isha</td></tr>
...
<h3>Awkat Ramadan for other cities in $country</h3>

<p>Here is the fasting month calendar of Ramadan other cities in $country.</p> <table style=\"padding:0px; margin:0px;\"><tr><td style=\"padding:0px; margin:0px;\"><ul style=\"padding-top:0px; margin-top:0px;\">
