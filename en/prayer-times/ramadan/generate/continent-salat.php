...
<h1>Ramadan Timetable <?=$continent?></h1>

<?php include("../../../../inc/pub-content.php");?>

<p style="padding-top:20px;"><a href="/en/prayer-times/ramadan/">Ramadan Calendar</a> > <strong><?echo $continent?></strong></p>

<p width="100%">Here are Ramadan timetables for <?echo number_format($count)?> main cities in <?echo $continent?>.</p>
...
<h2>Ramadan Calendar in <?=$continent?> (First day)</h2>
