...
<title>Ramadan Calendar <?echo $VilleNom?> Imsak and Iftar Timings in <?echo $VilleNom?> <?echo date(Y);?></title>

<meta name="description" content="Ramadan Calendar at <?echo $VilleNom?> in <?echo $VillePays?> for the year <?echo date(Y);?> - Prayer times during Ramadan in  <?echo $VilleNom?><? if(!empty($code)) echo " ($code)"?> and its surroundings."/>
