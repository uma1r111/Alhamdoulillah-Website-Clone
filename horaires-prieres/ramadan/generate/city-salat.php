...
<h1>Calendrier Ramadan <?echo $VilleNom?></h1>

<?php include("../../../../inc/pub-content.php");?>

<p style="padding-top:20px;"><a href="/horaires-prieres/ramadan/">Calendrier Ramadan</a> > <a href="/horaires-prieres/ramadan/<?echo str_replace(" ", "-", strtolower($VilleContinent));?>/"><?echo $VilleContinent?></a> > <a href="/horaires-prieres/ramadan/<? echo str_replace(" ", "-", strtolower($VilleContinent))?>/<? echo str_replace(" ", "-", strtolower($VillePays))?>/"><?echo $VillePays?></a> > <strong><?echo $VilleNom?></strong></p>

<img alt="salat <?echo $VilleNom?>" id="stamp" src="/images/heure-priere.png">

<p><b>Aujourd'hui</b> : <?php setlocale (LC_ALL, 'french'); echo strftime("%A %d %B %Y");?></p>
...
<p>Voici les horaires de rupture du jeune (iftar) à <?echo $VilleNom?> <? if(!empty($code)) echo "$code et ses environs";?>. L'heure de l'imsak correspond au moment de l'adhan et débute à <span id="fajr"></span> AM selon le calcul 18 degrés de la MWL <? if ($VillePays == 'France') echo "(<span id=\"fajr2\"></span> selon le calcul de l'UOIF, choix par défaut)";?> et l'heure de la rupture du jeûne, (maghrib) à <span id="maghrib"></span> PM.</p>

<center><div style="width:100%; display:block; height:5px; background-color:slategray; margin:0px;"></div></center>


<h2>Horaire Ramadan <?echo $VilleNom?></h2>
...
<select id="method" onchange="update()">
		<?php 
		if ($VillePays == 'France') echo "<option value=\"UOIF\" option=\"Fajr : 12° | Isha : 12°\" selected=\"selected\">Union des Organisations Islamiques de France</option>";?>
...
<h4 style="margin-left:15px;">Calendrier du Ramadan pour la ville de <?echo $VilleNom?></h4>
...
<div style="display:none"><h4 style="margin-left:20px;">Awqat Ramadan <?echo $VilleNom?> pour aujourd'hui, le <? echo date("d/m/Y");?>  :</h4>
<center>
...
<p>Vous pouvez aussi consulter notre calendrier des <a href="/horaires-prieres/monde/<? echo str_replace(" ", "-", strtolower($VilleContinent))?>/<? echo str_replace(" ", "-", strtolower($VillePays))?>/<? echo str_replace(" ", "-", strtolower($VilleNom))?>.html">heures de prière pour <?echo $VilleNom?></a>.</p>
...
{	"@context": "https://schema.org/",
	...
	"description": "Heure de l'imsak pour la ville de <?echo $VilleNom;?>",
...
{	"@context": "https://schema.org/",
	...
	"description": "Heure de la rupture du jeune pour la ville de <?echo $VilleNom;?>",
