...
<title>Horaire Ramadan <?=$country?> <?echo date(Y);?> - Calendrier Ramadan <?=$country?></title>

<meta name="description" content="Horaire du mois de Ramadan pour en <?echo $country?> (<?=$continent?>) - Cliquez ici pour accéder au calendrier du jeune du Ramadan pour les villes de <?echo $country?>."/>
