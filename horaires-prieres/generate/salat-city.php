...
<form method="post" name="method" id="method" action="<?php echo $_SERVER['PHP_SELF'];?>"><label for="calcul">Méthode de calcul :</label>
...
<tr><td>
<form method="post" name="asr" id="asr" action="<?php echo $_SERVER['PHP_SELF'];?>"><label for="hanafi">Heure de l'asr :</label>
...
<tr><td>
<form method="post" name="heure" id="heure" action="<?php echo $_SERVER['PHP_SELF'];?>"><label for="time">Format de l'heure :</label>
