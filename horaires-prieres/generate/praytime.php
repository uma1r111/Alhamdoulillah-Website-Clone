...
class PrayTime
{
    ...
    // Calculation Methods
    var $UOIF       = 0;    // UOIF
    var $ISNA       = 1;    // Islamic Society of North America (ISNA)
	var $MWL        = 2;    // Muslim World League (MWL)
	var $Makkah     = 3;    // Umm al-Qura, Makkah
	var $Egypt      = 4;    // Egyptian General Authority of Survey
	var $Karachi    = 5;    // University of Islamic Sciences, Karachi
    var $Tehran     = 6;    // Institute of Geophysics, University of Tehran
    ...
    */
    ...
    function PrayTime($methodID = 0)
    {
        ...
        $this->methodParams[$this->UOIF]      = array(12.55, 1, 3, 0, 12.55);
        $this->methodParams[$this->ISNA]      = array(15, 1, 3, 0, 15);
		$this->methodParams[$this->MWL]       = array(18, 1, 3, 0, 17);
        $this->methodParams[$this->Makkah]    = array(18.5, 1, 3, 1, 90);
		$this->methodParams[$this->Egypt]     = array(19.5, 1, 3, 0, 17.5);
		$this->methodParams[$this->Karachi]   = array(18, 1, 3, 0, 18);
