...
<p style="padding-top:20px;"><a href="/horaires-prieres/monde/">Monde</a> > <strong><?echo $continent?></strong></p>
...
<?php
	...
	$limit = $top/9;
	if ($continent == "Oceanie") $limit=0;
	if ($continent == "Europe") $limit=$limit*1.5;
