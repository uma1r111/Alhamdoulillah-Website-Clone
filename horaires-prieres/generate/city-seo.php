...
<title>Horaire Priere <?echo $VilleNom?><? if(!empty($code)) echo " $code";?> - Calendrier Heure Salat <?echo $VilleNom?> <?echo date(Y);?></title>

<meta name="description" content="Heure de prière à <?echo $VilleNom?> en <?echo $VillePays?> pour l'année <?echo date(Y);?> - Calendrier salat et horaires de prières précises pour la ville de <?echo $VilleNom?><? if(!empty($code)) echo " ($code)"?> et ses environs."/>
