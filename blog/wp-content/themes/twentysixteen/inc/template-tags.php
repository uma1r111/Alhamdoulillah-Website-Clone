...
function twentysixteen_entry_date() {
	...
	if ($test == "www.al-hamdoulillah.com/blog/actualite") 
	printf( '<div style="text-align:right; padding:15px;"><span class="posted-on"><u>Publié le %3$s</u></div>',
...
$link = sprintf( '<a href="%1$s" class="more-link">[%2$s]</a>',
		...
		sprintf( __( 'lire la suite', 'twentysixteen' ), get_the_title( get_the_ID() ) )
	);
	return ' &hellip; ' . $link;
}
